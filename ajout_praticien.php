            ...
            <div class="container">
              <div class="row">
                ...
                <form method="post" action="add.php">
                  <div class="mt-10">
                    <input type="text" class="form-control" name="nomAdd" placeholder="Nom du praticien" required><br/>
                    <input type="text" class="form-control" name="prenomAdd" placeholder="Prénom" required><br/>
                    <input type="text" class="form-control" name="adresseAdd" placeholder="Adresse" data-bv-regexp-regexp="[0-9]{0,4},\s[A-Za-z\s]{3,98}$" required><br/>
                    <input type="text" class="form-control" name="codpostAdd" placeholder="Code Postal" data-bv-regexp-regexp="^[0-9]{5,5}$" maxlength="5" required><br/>
                    <input type="text" class="form-control" name="villeAdd" placeholder="Ville" required><br/>
                    <input type="text" class="form-control" name="coefAdd" placeholder="Coefficient" required><br/>

                    <input type="text" class="form-control" name="typpraAdd" placeholder="Type praticien" data-bv-regexp-regexp="[0-9]{1,1}$" required><br/>
